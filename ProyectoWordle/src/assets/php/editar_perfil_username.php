<?php
    ...
    try {          
        ...
        $result = $conn->prepare("SELECT * FROM usuarios WHERE username='$username3'");
        $result->bindParam("username",$username3,PDO::PARAM_STR);
        $result->execute();
        ...
        if($count){
            ...
            if($count){ //Si hay un email igual ya registrado
                ...
                $sql = "UPDATE usuarios Set username='$username4' Where username='$username3'";
